...
L.Control.AccordionLegend = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        this.options.content.forEach(function (section) {
            ...
            if (section.directory !== false) {
                console.log(section)
                var sectitle = L.DomUtil.create('h2', 'accordionlegend-section-title ' + section_id + 'n_targ', panel);
            ...
            section.layers.forEach(function (layer) {
                ...
                var cbox = L.DomUtil.create('input', section_id + 'n', clbl);
                cbox.type  = 'checkbox';
                ...
                L.DomEvent.addListener(cbox, 'change', function () {
                    ...
                    // $('.' + cbox.classList.value).each( function(index, val) {
                    //     if($(val).attr('checked') == 'checked'){
                    //         $('.' + cbox.classList.value + '_targ').addClass('active_sec')
                    //         console.log(val)
                    //     }
                    // });
                    ...
                    console.log("onoff")
                    $(this).parent().parent().parent().find('input').each((index, val) =>{
                        console.log($(val).val())
                    ...
                    console.log("onoff")
                    // console.log($('.' + cbox.classList.value))
                    // console.log(onoff)
    ...
    toggleLayer: function (layername,onoff) {
        ...
        if (onoff) {
            ...
            $('.' + cbox.classList.value + '_targ').removeClass('active_sec')
        }
